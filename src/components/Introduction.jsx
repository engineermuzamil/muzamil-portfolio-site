...
export default function Introduction({ profileImage }) {
  return (
    <section id="introduction" className="container mx-auto px-4 mt-16 py-16 flex flex-col items-center text-center relative">
      <h1 className="text-2xl md:text-3xl font-semibold mb-4 text-slate-800 dark:text-white">Working late into the night to bring the best ideas to life!</h1>

      <div className="w-64 h-64 rounded-full bg-blue-100 dark:bg-blue-500/10 flex items-center justify-center mb-8 overflow-hidden transition-transform transform hover:scale-105">
        {profileImage ? (
          <img
            src={profileImage}
            alt="Profile"
